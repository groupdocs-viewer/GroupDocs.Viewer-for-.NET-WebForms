...
<body>
    ...
    <script type="text/javascript">
        $('#element').viewer({
            ...
            pageSelector: <%= config.Viewer.isPageSelector.ToString().ToLowerInvariant()%>,
            ...
            download: <%= config.Viewer.isDownload.ToString().ToLowerInvariant()%>,
            upload: <%= config.Viewer.isUpload.ToString().ToLowerInvariant()%>,
            print: <%= config.Viewer.isPrint.ToString().ToLowerInvariant()%>,
            browse: <%= config.Viewer.isBrowse.ToString().ToLowerInvariant()%>,
            rewrite: <%= config.Viewer.isRewrite.ToString().ToLowerInvariant() %>
            });
    </script>
</body>
</html>
